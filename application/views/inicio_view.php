...
<html lang="pt">
    ...
    <body>
        <div class=" flutuante_barra container-fluid barra_principal" style="background: #dcdcdc; color: white; ">
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7 col-md-3 margen_baixo">
                        <div class="thumbnail imagen_lista">
                            <img src="./imagens/imagen_teste.jpg">
                            <div class="caption alinha_direita">
                                <h3>Thumbnail label</h3>
                                <p>sdfasdf sdfsdfs sdfsadfsad asdfasdf asdfasdfasdf.</p>
