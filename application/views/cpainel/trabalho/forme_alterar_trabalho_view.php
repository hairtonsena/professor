...
<div class="row col-lg-12">
    <ol class="breadcrumb">
        ...
        <li class="active">Alterar trabalho </li>       
    </ol>
            ...
            <div class="col-lg-12 semMargem">
                ...
                <div class="col-lg-12 semMargem" style="/*border-left: 1px solid #ddd;border-right: 1px solid #ddd; border-bottom: 1px solid #ddd; */">
                    ...
                    <div class="col-lg-6"  style="padding-top: 5px; /* border-right: 1px solid #ddd; */">
                        ...
                        <form class="form-horizontal" action="<?php echo base_url("cpainel/trabalho/salvar_trabalho_alterada"); ?>" method="post" role="form">
                            <?php foreach ($trabalho as $tr) { ?>
                                <input type="hidden" name="trabalho" id="turma" value="<?php echo $tr->id_trabalho ?>" />
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="titulo_trabalho" class="form-control" id="titulo_trabalho" value="<?php echo $tr->titulo_trabalho ?>" placeholder="Titulo">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" name="data_entrega_trabalho" class="form-control" id="data_entrega_trabalho" value="<?php echo $tr->data_entrega_trabalho ?>" placeholder="Data entrega">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="valor_trabalho" class="form-control" id="valor_trabalho" value="<?php echo $tr->valor_nota_trabalho ?>" placeholder="Valor da nota">
                                        ...
                                        <div class="col-md-offset-2 col-sm-10">
                                            <div class="checkbox">
                                                <label for="abilitar_uplaod_trabalho">
                                                    ...
                                                    <input type="checkbox" id="abilitar_uplaod_trabalho" checked="true" name="abilitar_upload_trabalho" value="1" />
                                                    <?php }else{ ?>
                                                    <input type="checkbox" id="abilitar_uplaod_trabalho" name="abilitar_upload_trabalho" value="1"  />
                                                    <?php } ?>
