            ...
            <div class="col-lg-12">
                <form class="form-horizontal" action="<?php echo base_url("cpainel/disciplina/salvar_nova_disciplina"); ?>" method="post" role="form">
                    <div class="form-group">
                        ...
                        <input type="text" name="nome_disciplina" class="form-control" id="titulo" placeholder="">
                        <span class="text-danger"> <?php echo validation_errors(); ?></span>
                    </div>
                    <div class="form-group">
                        <label for="descricao" class=" control-label">Plano de ensino</label>
                        <textarea name="descricao_disciplina" class="form-control" id="descricao_diciplina" rows="12" placeholder="Descrição"></textarea>
                    </div>            
