...
foreach ($noticia as $nt) {
    ...
    $conteudo_noticia = $nt->conteudo_noticia;
}
?>
...
<div class="row col-lg-12">
    <ol class="breadcrumb">
        ...
        <li class="active">Alterar notícia </li>       
    </ol>
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="col-lg-12 semMargem" style="/*border-left: 1px solid #ddd;border-right: 1px solid #ddd; border-bottom: 1px solid #ddd; */">
                <form class="form-horizontal" action="<?php echo base_url("cpainel/noticia/salvar_noticia_alterada"); ?>" method="post" role="form">
                    ...
                    <fieldset>
                        ...
                        <div class="col-lg-4"  style="padding-top: 5px;">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="titulo_noticia" class="form-control" id="titulo_noticia" value="<?php echo $titulo_noticia ?>" placeholder="Nome">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="data_noticia" class="form-control" id="data_noticia" value="<?php echo date('d/m/Y', strtotime($data_noticia ))?>" placeholder="00/00/0000">
                        ...
                        <div class="col-lg-8"  style="padding-top: 5px; border-left: 1px solid #ddd;">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <textarea id="conteudo_noticia" name="conteudo_noticia" rows="6" class="form-control"><?php echo $conteudo_noticia ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
