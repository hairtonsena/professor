                    ...
                    <div class="col-lg-12"  style="padding-top: 5px; /* border-right: 1px solid #ddd; */">
                        ...
                        <div class="col-lg-8">
                            <div class="col-lg-12 text-right" style="margin-bottom: 10px;">
                                <span class="text-info" style="font-size: 22px"><i class="glyphicon glyphicon-globe"></i></span>
                                <a class="btn btn-danger" href="<?php echo base_url("cpainel/prova_online/editar_prova_online/".$prova_on_aux->id_prova_on_matriz) ?>" >Editar</a>
                                <a class="btn btn-success" href="<?php echo base_url("cpainel/prova_online/publicar_prova_online/".$prova_on_aux->id_prova_on_matriz) ?>" >Iniciar prova</a>
                            </div>
