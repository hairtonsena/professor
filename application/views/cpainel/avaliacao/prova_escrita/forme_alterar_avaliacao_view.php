...
<div class="row col-lg-12">
    <ol class="breadcrumb">
        ...
        <li class="active">Alterar avaliação </li>       
    </ol>
            ...
            <div class="col-lg-12 semMargem">
                ...
                <div class="col-lg-12 semMargem" style="/*border-left: 1px solid #ddd;border-right: 1px solid #ddd; border-bottom: 1px solid #ddd; */">
                    ...
                    <div class="col-lg-6"  style="padding-top: 5px; /* border-right: 1px solid #ddd; */">
                        ...
                        <form class="form-horizontal" action="<?php echo base_url("cpainel/avaliacao/salvar_prova_escrita_alterada"); ?>" method="post" role="form">
                            <?php foreach ($avaliacao as $av) { ?>
                                <input type="hidden" name="avaliacao" id="turma" value="<?php echo $av->id_avaliacao ?>" />
                                <fieldset>
                                    <legend>Alterar avaliação</legend>

                                    <div class="form-group">
                                        <label for="descricao_avaliacao" class="col-sm-2 control-label">Descrição</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="descricao_avaliacao" class="form-control" id="descricao_avaliacao" value="<?php echo $av->descricao_avaliacao ?>" placeholder="Descrição">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" name="data_avaliacao" class="form-control" id="data_avaliacao" value="<?php echo $av->data_avaliacao ?>" placeholder="Data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="valor_avaliacao" class="form-control" id="valor_avaliacao" value="<?php echo $av->valor_avaliacao ?>" placeholder="Valor">
