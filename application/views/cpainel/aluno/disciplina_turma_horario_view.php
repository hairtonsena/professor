        ...
        <div class="panel-body">
            <div class="col-lg-12">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class="active"><a href="<?php echo base_url("cpainel/aluno/disciplina_turma_horario?turma=".$id_turma."&aluno=".$id_aluno) ?>">Horários</a></li>
